                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                    ...
                    <tbody>
                     <?php if(is_array($row)): foreach($row as $key=>$v): ?><tr class="gradeX">
                        ...
                        <td class="center" style="text-align: center;"><img src="/kintime-webapp/<?php echo ($v["headpic"]); ?>" style="width:70px;height:50px"></td>
                   ...
                   <a href="<?php echo U('edit?id='.$v['id']);?>" class="btn btn_orange btn_flag"><span>修改</span></a>
                      <a href="<?php echo U('food/show?id='.$v['id']);?>" class="btn btn2 btn_archive"><span>查看本店菜单</span></a>
                            </td>
