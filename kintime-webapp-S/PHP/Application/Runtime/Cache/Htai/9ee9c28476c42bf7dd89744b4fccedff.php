...
.page{
  height:33px;
    ...
    <div id="contentwrapper" class="contentwrapper">
        <form action="<?php echo U('user/q_user');?>" method='get'>
         <!-- 搜索框-->
           <div id="dyntable_length" class="dataTables_length">
            ...
            <div class="dataTables_filter" style='width:400px' id="dyntable_filter">
                <label>账号或电话: <input type="text" name='search' style='width:65%' /></label>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                    ...
                    <tbody>
                     <?php if(is_array($row)): foreach($row as $key=>$v): ?><tr class="gradeX">
                            ...
                            <td class="center"><?php echo ($v["type"]); ?></td>
                            <td class="center"><a href='<?php echo U('q_userkan?id='.$v['id']);?>'>查看</a></td>
