...
.page{
  height:33px;
    ...
    <div id="contentwrapper" class="contentwrapper">
        <form action="<?php echo U('food/index');?>" method='get'>
         <!-- 搜索框-->
           <div id="dyntable_length" class="dataTables_length" style="padding:6px">
          <!--   <a href="<?php echo U('food/add');?>" class="btn btn_orange btn_flag"><span>添加菜</span></a>  -->
            ...
            <div class="dataTables_filter" style='width:400px;margin-top:-35px' id="dyntable_filter">
                <label>菜名: <input type="text" name='search' style='width:65%' /></label>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head1" style="text-align: center;">菜名</th>
                            <th class="head1" style="text-align: center;">主图</th>
                            <th class="head0" style="text-align: center;">单价</th>
                            <th class="head1" style="text-align: center;">折扣</th>
                            <th class="head1" style="text-align: center;">查看图片</th>
                            <th class="head1" style="text-align: center;">限时抢购</th>
                            <th class="head0" style="text-align: center;">对应菜品分类</th>
                            <th class="head1" style="text-align: center;">热销</th>
                            <th class="head1" style="text-align: center;">对应商铺</th>
                            <th class="head1" style="text-align: center;">对应种类</th>
                            <th class="head1" style="text-align: center;">外卖好评度</th> 
                            <th class="head1" style="text-align: center;">外卖销量</th> 
                            <th class="head1" style="text-align: center;">堂食销量</th>
                            <th class="head1" style="text-align: center;">口味</th>
                            <th class="head1" style="text-align: center;">温度</th>
                            <th class="head1" style="text-align: center;">规格</th>
                            <th class="head1" style="text-align: center;">是否可以外卖</th>
                    ...
                    <tbody>
                     <?php if(is_array($row)): foreach($row as $key=>$v): ?><tr class="gradeX">
                            ...
                            <td class="center" style="text-align: center;"><?php echo ($v["cainame"]); ?></td>
                            <td class="center" style="text-align: center;"><img src="/kintime-webapp/<?php echo ($v["headpic"]); ?>" style="width:60px;height:40px"></td>
                            <td class="center" style="text-align: center;"><?php echo ($v["price"]); ?></td>
                            <td class="center" style="text-align: center;"><?php echo ($v["zhekou"]); ?></td>
             <td class="center" style="text-align: center;"><a href="<?php echo U('food/pic?id='.$v['id']);?>" class="btn btn4 btn_yellow btn_search radius50"></a></td>
              <td class="center" style="text-align: center;"><a href="<?php echo U('food/qianggou?id='.$v['id']);?>" class="btn btn4 btn_yellow btn_search radius50"></a></td>               
                            <td class="center" style="text-align: center;"><?php echo ($v["typeid"]); ?></td>
                            <td class="center" style="text-align: center;"><?php echo ($v["rx"]); ?></td>
                            <td class="center" style="text-align: center;"><?php echo ($v["sid"]); ?></td>
                            <td class="center" style="text-align: center;"><?php echo ($v["stypeid"]); ?> </td>
                            <td class="center" style="text-align: center;"><?php echo ($v["m_ping"]); ?> </td>
                            <td class="center" style="text-align: center;"><?php echo ($v["m_xl"]); ?> </td>
                            <td class="center" style="text-align: center;"><?php echo ($v["xl"]); ?> </td>
                            <td class="center" style="text-align: center;"><?php echo ($v["kouwei"]); ?> </td>
                            <td class="center" style="text-align: center;"><?php echo ($v["wendu"]); ?> </td>
                            <td class="center" style="text-align: center;"><?php echo ($v["guige"]); ?> </td>
                            <td class="center" style="text-align: center;"><a  class="btn btn2 btn_bulb"><span><?php echo ($v["wmstate"]); ?> </span></a></td>
                            <td class="center" style="text-align: center;"><button class="stdbtn btn_red"><?php echo ($v["state"]); ?> </button></td>
                            <td class="center" style="text-align: center;">
                            <a href='<?php echo U('edit?id='.$v['id']);?>' class="btn btn2 btn_blue btn_flag"><span>修改</span></a></td>
