				...
				$.each(data, function(index,item) {
					if(item.id){
						...
						if(item.sex==='1'){
							...
							str+='女士</span><span class="phone-con">18957556486</span></div></div><span class="select-con"><span class="edit-con"><i class="iconfont icon-edit"></i></span><span class="back-con"><i class="iconfont icon-ok"></i></span></span></li>';
						};
					};
				});
