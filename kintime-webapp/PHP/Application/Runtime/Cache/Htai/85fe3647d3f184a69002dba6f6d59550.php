 ...
 -->
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            <h1 class="pagetitle">商铺信息（只允许修改商铺状态）</h1>

        </div><!--pageheader-->

            <div id="validation" class="subcontent" >
                
                    <form id="form1" class="stdform" method="post" action="<?php echo U('shop/edit');?>" enctype="multipart/form-data">
                    <!--隐藏域-->
                    <input type='hidden' name="id" id="firstname" style="width:30%" class="longinput" value="<?php echo ($row["id"]); ?>" />

                      <p>
                          <label>店铺名&nbsp;</label>
                            <span class="field"><input type="text" id="firstname" style="width:30%" class="longinput" value="<?php echo ($row["name"]); ?>" name="name" disabled />&nbsp;<a href="<?php echo U('pj_shop?id='.$row['id']);?>">查看评价</a></span>
                        </p>
                        <p>
                          <label>店铺电话&nbsp;</label>
                            <span class="field"><input type="text" id="email" class="longinput" style="width:30%" value="<?php echo ($row["phone"]); ?>" name="phone" disabled /></span>
                        </p>
                        
                        <p>
                            <label>店铺地址&nbsp;</label>
                            <span class="field"><input type="text" id="email" class="longinput" style="width:30%" value="<?php echo ($row["address"]); ?>" name="address" disabled /></span>
                        </p>
                        <!-- <p>
                            <label>用户id&nbsp;</label>
                        ...
                        <p>
                         ...
                         <p>
                            <label>营业时间&nbsp;</label>
                            <span class="field"><input type="text" id="email" class="longinput" style="width:30%" value="<?php echo ($row["begintime"]); ?>" name="begintime" disabled /></span>
                        </p>
                         <p>
                            <label>结束时间&nbsp;</label>
                            <span class="field"><input type="text" id="email" class="longinput" style="width:30%" value="<?php echo ($row["overtime"]); ?>" name="overtime" disabled /></span>
                        </p>
                        <p>
                            <label>商铺头像预览&nbsp;</label>
