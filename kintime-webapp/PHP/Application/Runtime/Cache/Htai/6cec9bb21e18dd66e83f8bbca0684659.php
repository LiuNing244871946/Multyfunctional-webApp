...
.page{
  height:33px;
    ...
    <div class="pageheader">
        <h1 class="pagetitle">权限组信息 </h1>
 
        <h5><a href=<?php echo U('hiadd_qx');?> style='float:right'>添加权限组&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></h5>
    ...
    <div id="contentwrapper" class="contentwrapper">
        <form action="<?php echo U('user/hi_qx');?>" method='get'>
         <!-- 搜索框-->
           <div id="dyntable_length" class="dataTables_length">
            ...
            <div class="dataTables_filter" style='width:400px' id="dyntable_filter">
                <label>组名: <input type="text" name='search' style='width:65%' /></label>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            <th class="head0">组名</th>
                            <th class="head1">组人数</th>
                            <th class="head0" style='width:25%'>操作</th>
                        </tr>
                    </thead>

                    <tbody>
                     <?php if(is_array($g_row)): foreach($g_row as $key=>$v): ?><tr class="gradeX">
                         
                            <td class="center"><?php echo ($v["gname"]); ?></td>
                            <td class="center"><?php echo ($v["count"]); ?></td>
                            <td class="center"><a href='<?php echo U('hi_qxkan?id='.$v['id']);?>'>查看</a>
                             &nbsp;&nbsp;|&nbsp;&nbsp; <a href='<?php echo U('hi_qxdel?id='.$v['id']);?>'>删除</a></td>
