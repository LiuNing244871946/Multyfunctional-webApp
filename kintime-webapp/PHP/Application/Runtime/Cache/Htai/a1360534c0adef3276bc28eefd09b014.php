...
<div class="bodywrapper">
 ...
 <form class="stdform" action="<?php echo U('adddo');?>" method="post" >
                        
                        <p>
                            <label>属于的分类：</label>
                            <span class="field"><input type="text" value="<?php echo ($name); ?>" class="smallinput" placeholder="请输入商品的类别" disabled /></span>
                           
                        </p>
                         <p>
                            <label>分类名：</label>
                            <span class="field"><input type="text" name="name" class="smallinput" placeholder="请输入分类名" /></span>
                           
                        </p>
                        <!--隐藏域-->
                        <input type="hidden" name="pid" value="<?php echo ($pid); ?>">
                        <input type="hidden" name="path" value="<?php echo ($path); echo ($pid); ?>">
