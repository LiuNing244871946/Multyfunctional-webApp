 ...
 -->
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            <h1 class="pagetitle">管理员信息修改</h1>

        </div><!--pageheader-->

            <div id="validation" class="subcontent" >
                
                    <form id="form1" class="stdform" method="post" action="<?php echo U('h_userkan');?>" enctype="multipart/form-data">
                    <input type='hidden' name="id" id="firstname" style="width:30%" class="longinput" value="<?php echo ($row["id"]); ?>" />
                    <input type='hidden' name="old_pic" id="firstname" style="width:30%" class="longinput" value="<?php echo ($row["headpic"]); ?>" />
                      <p>
                          <label>账&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号</label>
                        ...
                        <p>
                          <label>用&nbsp;&nbsp;&nbsp;户&nbsp;&nbsp;&nbsp;名</label>
                            <span class="field"><input type="text" name="username" id="email" class="longinput" style="width:30%" value="<?php echo ($row["username"]); ?>"/></span>
                        </p>
                        
                        <p>
                            <label>邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱</label>
                            <span class="field"><input type="text" name="email" id="email" class="longinput" style="width:30%" value="<?php echo ($row["email"]); ?>"/></span>
                        </p>
                        <p>
                        <p>
                            <label>用&nbsp;户&nbsp;头&nbsp;像</label>
                            <span class="field"><input type="file" name="pic" id="email" class="longinput" style="width:30%" value="" /></span>
                            <img src="/kintime/Public/../Uploads/<?php echo ($row["headpic"]); ?>" width="120">
                        </p>
                        <p>
                            <label>用&nbsp;户&nbsp;权&nbsp;限</label>
                             <span class="field">
                             <select size="1" style='min-width:20%' name="glid" <?php echo ($row['id']==1?'disabled':''); ?> >
                                <?php if(is_array($ga_row)): foreach($ga_row as $key=>$v): ?><option  value="<?php echo ($v['id']); ?>" <?php echo ($row['glid']==$v['gname']?'selected':''); ?>><?php echo ($v["gname"]); ?></option><?php endforeach; endif; ?>
                             </select>
                             </span>
                        </p>
