...
.page{
  height:33px;
    ...
    <div class="pageheader">
        <h1 class="pagetitle">&nbsp;优惠券详情</h1>
        <!-- <h5><a href=<?php echo U('hadd_user');?> style='float:right'>添加优惠券&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></h5> -->
    </div><!--pageheader-->
        

    
    <div id="contentwrapper" class="contentwrapper">
        <form action="<?php echo U('juanzi');?>" method='get'>
         <!-- 搜索框-->
           <div id="dyntable_length" class="dataTables_length">
            ...
            <div class="dataTables_filter" style='width:400px' id="dyntable_filter">
                <label>优惠券编码: <input type="text" name='search' style='width:65%' /></label>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            <th class="head0" width="8%">优惠券编码</th>
                            <th class="head1">使用金额</th>
                            <th class="head0">抵用金额</th>
                            <th class="head1">可用商家</th>
                            <th class="head0">所属用户</th>
                            <th class="head1">优惠券类型</th>
                            <th class="head0" width="15%">有效期至</th>
                    ...
                    <tbody>
                     <?php if(is_array($row)): foreach($row as $key=>$v): ?><tr class="gradeX">
                            ...
                            <td class="center"><?php echo ($v["tj"]); ?></td>
                            <td class="center"><?php echo ($v["djin"]); ?></td>
                            <td class="center"><?php echo ($v["sid"]); ?></td>
                            <td class="center"><?php echo ($v["uid"]); ?></td>
                            <td class="center"><?php echo ($v["name"]); ?></td>
                            <td class="center"><?php echo ($v["stop"]); ?></td>
                            
                            <!-- <td class="center"><a href='<?php echo U('kan_show?id='.$v['id']);?>'>删除</a></td> -->
