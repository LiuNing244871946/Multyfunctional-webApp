                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                    ...
                    <tbody>
                     <?php if(is_array($row)): foreach($row as $key=>$v): ?><tr class="gradeX">
                        ...
                        <td class="center" style="text-align: center;"><img src="/kintime/Public/../Uploads/<?php echo ($v["headpic"]); ?>" style="width:70px;height:50px"></td>
                            ...
                            <td class="center" style="text-align: center;"><?php echo ($v["begintime"]); ?></td>
                            <td class="center" style="text-align: center;"><?php echo ($v["overtime"]); ?></td>
