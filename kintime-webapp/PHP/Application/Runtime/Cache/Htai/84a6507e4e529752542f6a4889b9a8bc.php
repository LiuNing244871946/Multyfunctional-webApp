...
.page{
  height:33px;
    ...
    <div id="contentwrapper" class="contentwrapper">
        <form action="<?php echo U('max_show');?>" method='get'>
         <!-- 搜索框-->
           <div id="dyntable_length" class="dataTables_length">
            ...
            <div class="dataTables_filter" style='width:400px' id="dyntable_filter">
                <label>用户账号: <input type="text" name='search' style='width:65%' /></label>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head1">卖家</th>
                            <th class="head0">买家</th>
                            <th class="head1">订单时间</th>
                            <th class="head0">优惠价</th>
                            <th class="head1">订单状态</th>
                            <th class="head1">是否可见</th>
                    ...
                    <tbody>
                     <?php if(is_array($row)): foreach($row as $key=>$v): ?><tr class="gradeX">
                            ...
                            <td class="center"><?php echo ($v["you"]); ?></td>
                            <td class="center"><?php echo ($v["ztai"]); ?></td>
                            <td class="center"><?php echo ($v["see"]); ?></td>
                            <td class="center"><a href='<?php echo U('kan_show?id='.$v['id']);?>'>查看</a></td>
