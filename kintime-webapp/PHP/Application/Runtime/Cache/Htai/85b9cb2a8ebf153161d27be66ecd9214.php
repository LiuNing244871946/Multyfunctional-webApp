...
<div class="bodywrapper">
    ...
    <div class="vernav2 iconmenu">
        <ul>
            ...
            <li><a href="elements.html" class="elements">di</a></li>
...
.dataTables_filter{
    ...
    <div id="contentwrapper" class="contentwrapper">
        <form action="<?php echo U('food/show');?>" method='get'>
         <!-- 搜索框-->
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head0" style="text-align: center;">菜品分类id</th>
                            <th class="head1" style="text-align: center;">热销</th>
                            <th class="head1" style="text-align: center;">对应商铺id</th>
                    ...
                    <tbody>
                     <?php if(is_array($row)): foreach($row as $key=>$v): ?><tr class="gradeX">
                            ...
                            <td class="center" style="text-align: center;"><?php echo ($v["wmstate"]); ?> </td>
                            <td class="center" style="text-align: center;"><?php echo ($v["state"]); ?> </td>
                            <td class="center" style="text-align: center;"><a href='<?php echo U('edit?id='.$v['id']);?>'>修改</a></td>
