...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            <h1 class="pagetitle">权限组修改</h1>

        </div><!--pageheader-->

            <div id="validation" class="subcontent" >
                
        <form action="<?php echo U('hi_qxkan');?>" method='post'>
            <table class="stdtable stdtablecb" cellspacing="0" cellpadding="0" border="0" style="width:40%;">
              <colgroup>
            ...
            <input type="hidden" name='id' value='<?php echo ($_GET['id']); ?>'>
                  ...
                  <tbody>
                      <?php if(is_array($grow)): foreach($grow as $key=>$v): ?><tr class="">
                            <td align="center">
                              <input  type="checkbox"  name='name[]' value='<?php echo ($v["pname"]); ?>' <?php echo ($v["ch"]); ?> >
                            </td>
                  ...
                  <ul class="buttonlist">
                      ...
                      <li><button class="stdbtn btn_yellow">修 改</button></li>
                    </ul>
