...
.page{
  height:33px;
    ...
    <div id="contentwrapper" class="contentwrapper">
        <form action="<?php echo U('gwshop/index');?>" method='get'>
         <!-- 搜索框-->
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head1" style="text-align: center;">店铺说明</th>
                            <th class="head1" style="text-align: center;">销量</th>
                            <th class="head0" style="text-align: center;">头像</th>
                            <th class="head1" style="text-align: center;">对应的商铺分类</th>
                            ...
                            <th class="head1" style="text-align: center;">店铺状态</th>
                    ...
                    <tbody>
                     <?php if(is_array($row)): foreach($row as $key=>$v): ?><tr class="gradeX">
                            ...
                            <td class="center" style="text-align: center;"><?php echo ($v["shuoming"]); ?></td>
                            <td class="center" style="text-align: center;"><?php echo ($v["xiaoliang"]); ?></td>
                        <td class="center" style="text-align: center;"><img src="../<?php echo ($v["headpic"]); ?>" style="width:70px;height:50px"></td>
                            <td class="center" style="text-align: center;"><?php echo ($v["g_typeid"]); ?></td>
                             <td class="center" style="text-align: center;"><a href="<?php echo U('gwshop/pic?id='.$v['id']);?>" class="btn btn4 btn_yellow btn_search radius50"></a></td>
                            <td class="center" style="text-align: center;"><?php echo ($v["begintime_h"]); ?>:<?php echo ($v["begintime_i"]); ?></td>
                            <td class="center" style="text-align: center;"><?php echo ($v["overtime_h"]); ?>:<?php echo ($v["overtime_i"]); ?></td>
                   ...
                   <a href="<?php echo U('edit?id='.$v['id']);?>" class="btn btn_orange btn_flag"><span>修改</span></a>
                      <a href="<?php echo U('food/show?id='.$v['id']);?>" class="btn btn2 btn_archive"><span>查看本店商品</span></a>
                            </td>
