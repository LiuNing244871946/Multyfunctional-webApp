...
.page{
  height:33px;
    ...
    <div id="contentwrapper" class="contentwrapper">
        <form action="<?php echo U('gouwu/gouwushow');?>" method='get'>
         <!-- 搜索框-->
           <div id="dyntable_length" class="dataTables_length">
            <a href="<?php echo U('gouwu/add');?>" class="btn btn2 btn_blue btn_flag"><span>添加商家账号</span></a>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                    ...
                    <tbody>
                     <?php if(is_array($row)): foreach($row as $key=>$v): ?><tr class="gradeX">
                        ...
                        <?php if($v['type'] == 6 ): ?><td class="center" style="text-align: center;"><a href="<?php echo U('gouwu/shop?id='.$v['id']);?>"  class="btn btn2 btn_blue btn_search radius50"><span>送达</span></a> </td>
                        <?php elseif($v['type'] == 7 ): ?> 
                            <td class="center" style="text-align: center;"><a href="<?php echo U('gouwu/m_shop?id='.$v['id']);?>"  class="btn btn2 btn_blue btn_search radius50"><span>上门</span></a></td>
                        <?php elseif($v['type'] == 8 ): ?> 
                            <td class="center" style="text-align: center;"><a href="<?php echo U('gouwu/m_shop?id='.$v['id']);?>"  class="btn btn2 btn_blue btn_search radius50"><span>送达+上门</span></a></td><?php endif; ?>

                      <?php if($v['type'] == 8): ?><!-- 送达 -->
                          <?php if($v['shopid'] != 0 ): ?><!-- 有店铺 --><td class="center" style="text-align: center;"><a  class="btn btn2 btn_blue btn_home"><span>已有</span></a>
                          <?php else: ?> 
                              <!-- 没有添加 --><td class="center" style="text-align: center;"><a href="<?php echo U('upass/shopadd?id='.$v['id'].'&type='.$v['type']);?>" class="btn btn2 btn_blue btn_home"><span>送达</span></a><?php endif; ?>

                          <!-- 上门 -->
                          <?php if($v['m_shopid'] != 0 ): ?><!-- 有店铺 --><a  class="btn btn2 btn_blue btn_home"><span>已有</span></a></td>
                          <?php else: ?> 
                              <!-- 没有添加 --><a href="<?php echo U('upass/m_shopadd?id='.$v['id'].'&type='.$v['type']);?>" class="btn btn2 btn_blue btn_home"><span>上门</span></a></td><?php endif; ?>
                      <?php else: ?>
                          ...
                          <?php if($v['type'] == 6 ): ?><!-- 送达 -->
                                ...
                                <?php else: ?> 
                                       <!-- 没有添加 --><td class="center" style="text-align: center;"><a href="<?php echo U('upass/shopadd?id='.$v['id'].'&type='.$v['type']);?>" class="btn btn2 btn_blue btn_home"><span>送达</span></a></td><?php endif; ?>
                          <?php elseif($v['type'] == 7 ): ?>
                                <!-- 上门 -->
                                <?php if($v['m_shopid'] != 0 ): ?><!-- 有店铺 --><td class="center" style="text-align: center;"><a  class="btn btn2 btn_blue btn_home"><span>已有</span></a></td>
                                <?php else: ?> 
                                         <!-- 没有添加 --><td class="center" style="text-align: center;"><a href="<?php echo U('upass/shopadd?id='.$v['id'].'&type='.$v['type']);?>" class="btn btn2 btn_blue btn_home"><span>上门</span></a></td><?php endif; endif; endif; ?>
