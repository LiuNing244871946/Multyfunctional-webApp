...
.page{
  height:33px;
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <form action="<?php echo U('lunbo/index');?>" method='get'>

         <!-- 搜索框-->
           <div id="dyntable_length" class="dataTables_length">
        <a href="<?php echo U('lunbo/add');?>" class="btn btn2 btn_blue btn_flag"><span>添加轮播图</span></a>
        <!--   <button class="stdbtn btn_red" style="disabled">请点击最右边的提交按钮进行相关操作!</button> -->
            ...
            <div class="dataTables_filter" style='width:400px;right:900px;top:93px' id="dyntable_filter">
                <!-- <label>分类: <input type="text" name='search' style='width:65%' /></label> -->
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head1" style="text-align: center;">轮播图</th>
                            <th class="head0" style="text-align: center;">URL</th>
                            <th class="head1" style="text-align: center;">分类</th>
                    ...
                    <tbody>
                     <?php if(is_array($row)): foreach($row as $key=>$v): ?><tr class="gradeX">
                            ...
                            <td class="center" style="text-align: center;"><img src="/<?php echo ($v["pic"]); ?>" style="width:120px;height:70px"></td>
                            <td class="center" style="text-align: center;"><?php echo ($v["url"]); ?></td>
                        <?php if($v['type'] == 1 ): ?><td class="center" style="text-align: center;">首页轮播图</td>
                        <?php elseif($v['type'] == 2 ): ?> 
                            <td class="center" style="text-align: center;">美食轮播图</td>
                        <?php elseif($v['type'] == 3 ): ?>
                             <td class="center" style="text-align: center;">外卖轮播图</td><?php endif; ?>
                            

                            <td class="center" style="text-align: center;">
                   <a href="<?php echo U('edit?id='.$v['id']);?>" class="btn btn_blue btn_flag"><span>修改</span></a>
                    <a href="<?php echo U('del?id='.$v['id']);?>" class="btn btn2 btn_trash"><span>删除</span></a>
                            </td>
