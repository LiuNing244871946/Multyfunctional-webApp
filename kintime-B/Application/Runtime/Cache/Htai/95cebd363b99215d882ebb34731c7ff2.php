...
<div class="bodywrapper">
 ...
 <form class="stdform" action="<?php echo U('editdo');?>" method="post" >
                        
                        <p>
                            <label>修改前分类：</label>
                            <span class="field"><input type="text" value="<?php echo ($name); ?>" class="smallinput"  disabled /></span>
                           
                        </p>
                         <p>
                            <label>修改后分类名：</label>
                            <span class="field"><input type="text" name="name" value="<?php echo ($name); ?>" class="smallinput" placeholder="请输入分类名" /></span>
