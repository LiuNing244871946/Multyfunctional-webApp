...
.page{
  height:33px;
    ...
    <div class="pageheader">
        <h1 class="pagetitle">后台管理员信息 </h1>
 
        <h5><a href=<?php echo U('hadd_user');?> style='float:right'>添加管理员&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></h5>
    ...
    <div id="contentwrapper" class="contentwrapper">
        <form action="<?php echo U('user/h_user');?>" method='get'>
         <!-- 搜索框-->
           <div id="dyntable_length" class="dataTables_length">
            ...
            <div class="dataTables_filter" style='width:400px' id="dyntable_filter">
                <label>管理员账号: <input type="text" name='search' style='width:65%' /></label>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            <th class="head0">账号</th>
                            <th class="head1">用户名</th>
                            <th class="head0">邮箱</th>
                            <th class="head0">管理权限</th>
                    ...
                    <tbody>
                     <?php if(is_array($row)): foreach($row as $key=>$v): ?><tr class="gradeX">
                            ...
                            <td class="center"><?php echo ($v["g_gl"]); ?></td>
                            <td class="center"><a href='<?php echo U('h_userkan?id='.$v['id']);?>'>查看</a>
                            <?php if($v['id'] != 1 ): ?>&nbsp;&nbsp;|&nbsp;&nbsp; <a href='<?php echo U('h_userdel?id='.$v['id']);?>'>删除</a></td><?php endif; ?>
