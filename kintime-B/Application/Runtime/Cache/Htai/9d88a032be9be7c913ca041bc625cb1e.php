...
.page{
  height:33px;
    ...
    <div class="pageheader">
        <h1 class="pagetitle">所有骑手账号信息 </h1>
    </div><!--pageheader-->
    <div id="contentwrapper" class="contentwrapper">
        <form action="<?php echo U('qshou/index');?>" method='get'>
         <!-- 搜索框-->
           <div id="dyntable_length" class="dataTables_length">
            <a href="<?php echo U('qshou/add');?>" class="btn btn2 btn_blue btn_flag"><span>添加骑手账号</span></a>
            ...
            <div class="dataTables_filter" style='width:400px' id="dyntable_filter">
                <label>姓名/电话: <input type="text" name='search' style='width:65%' /></label>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head0" style="text-align: center;">姓名</th>
                            <th class="head1" style="text-align: center;">电话</th>
                            <th class="head1" style="text-align: center;">接单数量</th>
                            <th class="head1" style="text-align: center;">头像</th>
                            <th class="head1" style="text-align: center;">评分</th>
                            <th class="head1" style="text-align: center;">账号状态</th>
                            <th class="head0" style="text-align: center;">骑手状态</th>
                    ...
                    <tbody>
                     <?php if(is_array($row)): foreach($row as $key=>$v): ?><tr class="gradeX">
                            ...
                            <td class="center" style="text-align: center;"><?php echo ($v["num"]); ?></td>
                            ...
                            <?php if($v['qsstate'] == 1 ): ?><td class="center" style="text-align: center;"><a href="" class="btn btn2 btn_flag"><span>开工了</span></a></td>
                            <?php elseif($v['qsstate'] == 2 ): ?> 
                            <td class="center" style="text-align: center;"><a href="" class="btn btn2 btn_help"><span>忙碌中</span></a></td>
                            <?php elseif($v['qsstate'] == 3 ): ?> 
                            <td class="center" style="text-align: center;"><a href="" class="btn btn2 btn_bell"><span>收工了</span></a></td><?php endif; ?>

                         
                         <td class="center" style="text-align: center;"><a href="<?php echo U('qshou/edit?id='.$v['id']);?>"  class="btn btn2 btn_blue btn_link"><span>修改状态</span></a></td> 
