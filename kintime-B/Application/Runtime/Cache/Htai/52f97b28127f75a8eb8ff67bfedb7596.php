...
.page{
  height:33px;
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <form action="<?php echo U('bawang/index');?>" method='get'>

         <!-- 搜索框-->
           <div id="dyntable_length" class="dataTables_length">
        <a href="<?php echo U('tehui/add');?>" class="btn btn2 btn_blue btn_flag"><span>添加特惠店铺</span></a>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head1" style="text-align: center;">店铺id</th>
                            <th class="head0" style="text-align: center;">结束时间</th>
                      <!--       <th class="head1" style="text-align: center;">链接</th> -->
                            <th class="head0" style="text-align: center;">头像</th>
                            <th class="head0" style="text-align: center;">分类</th>
                    ...
                    <tbody>
                     <?php if(is_array($row)): foreach($row as $key=>$v): ?><tr class="gradeX">
                            ...
                            <td class="center" style="text-align: center;"><?php echo ($v["type"]); ?> </td>
