...
.page{
  height:33px;
    ...
    <div id="contentwrapper" class="contentwrapper">
        <form action="<?php echo U('mshop/index');?>" method='get'>
         <!-- 搜索框-->
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head0" style="text-align: center;">主图</th>
                            <th class="head1" style="text-align: center;">商铺分类ID</th>
                            <th class="head1" style="text-align: center;">好评度</th>
                           <!--  <th class="head1" style="text-align: center;">人均</th> -->
                            <th class="head1" style="text-align: center;">配送费</th>
                           <!--  <th class="head1" style="text-align: center;">起送价</th> -->
                            <th class="head1" style="text-align: center;">查看代金券</th>
                            ...
                            <th class="head1" style="text-align: center;">营业时间</th>
                            <th class="head1" style="text-align: center;">结束时间</th>
                    ...
                    <tbody>
                     <?php if(is_array($row)): foreach($row as $key=>$v): ?><tr class="gradeX">
                            ...
                            <td class="center" style="text-align: center;"><?php echo ($v["uid"]); ?></td>
                              <td class="center" style="text-align: center;"><a href="<?php echo U('mshop/pic?id='.$v['id']);?>" class="btn btn4 btn_yellow btn_search radius50"></a></td>
                            ...
                            <!-- <td class="center" style="text-align: center;"><?php echo ($v["jun"]); ?></td> -->
                            <td class="center" style="text-align: center;"><?php echo ($v["song"]); ?></td>
                             <!-- <td class="center" style="text-align: center;"><?php echo ($v["gogo"]); ?></td> -->
                             <td class="center" style="text-align: center;"><a href="<?php echo U('mshop/cc?id='.$v['id']);?>" class="btn btn4 btn_search"></a></td>
                            ...
                            <td class="center" style="text-align: center;"><?php echo ($v["hi_b"]); ?> </td>
                            <td class="center" style="text-align: center;"><?php echo ($v["hi_o"]); ?> </td>
                   ...
                   <a href="<?php echo U('del?id='.$v['id']);?>" class="btn btn_orange btn_trash"><span>删除</span></a>
                      <a href="<?php echo U('mshop/show?id='.$v['id']);?>" class="btn btn2 btn_archive"><span>查看本店菜单</span></a>
                            </td>
